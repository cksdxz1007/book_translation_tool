...
class TokenChunker:
    ...
    def get_stats(self, chunks: List[Dict[str, str]]) -> Dict:
        ...
        Returns:
            ...
            - chunks_in_range: Number of chunks within max_tokens limit
            - compliance_rate: Percentage of chunks within limit
        """
        if not chunks:
            return {
                "total_chunks": 0,
        ...
        # Calculate how many are within acceptable range (up to max_tokens)
